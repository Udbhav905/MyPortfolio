...
export default function About() {
  return (
    <section id="about" className="relative py-24 px-6 md:px-12 bg-[#0B0E14] border-t border-[#222936]">
      <div className="max-w-6xl mx-auto">
        {/* Grid columns take their natural height */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          
          {/* LEFT COLUMN – no forced alignment */}
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="border border-[#222936] bg-[#121720] p-4 overflow-hidden">
              <div className="relative w-full h-[250px] md:h-[350px] lg:h-[200px]">
                <Image src="/my_image.jpg" alt="Udbhav Prajapati" fill className="object-cover" />
              </div>
            </div>

            <div className="border border-[#222936] bg-[#121720] p-6 md:p-8 flex flex-col justify-center items-center text-center space-y-2 relative overflow-hidden group hover:border-[#3B82F6]/30 transition-all duration-300">
              ...
              <p className="text-xs font-mono uppercase tracking-wider text-[#A0AEC0]">
                Months of Coding & App Development
              </p>
              <p className="text-[10px] font-mono text-[#5A6E85]">
                Self-Taught & Professionally Interned
              </p>
            </div>
          </div>

          {/* RIGHT COLUMN – no forced gap, bottom line sticks directly under last paragraph */}
          <div className="lg:col-span-8">
            <motion.div
              ...
              className="space-y-6 text-[#A0AEC0] text-sm md:text-base leading-relaxed"
            >
