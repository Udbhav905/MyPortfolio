...
import { ArrowRight, ChevronRight, Mail, Download } from 'lucide-react';
...
export default function Hero() {
  ...
  const handleDownloadResume = () => {
    ...
    link.href = '/Udbhav_FD.pdf'; // Update with your actual file name
      ...
      <div className="max-w-4xl mx-auto w-full z-10 space-y-8">
        ...
        <div className="flex flex-wrap gap-4 pt-4">
          ...
          <button
            ...
            className="px-6 py-3 border border-[#222936] bg-transparent hover:border-[#3B82F6] text-[#A0AEC0] hover:text-[#EDF2F7] font-mono text-xs uppercase tracking-widest transition-all duration-200 flex items-center gap-2 rounded-none"
          >
